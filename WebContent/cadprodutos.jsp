			...
			<h2>Cadastro de Produtos</h2>
				<form action="cadProduto" method="post">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="fornecedor" placeholder="Fornecedor do Produto">
					</div>
					<div class="form-group">
						<label>Tipo</label>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="numSerie" placeholder="Número de Série do Produto">
					</div>
