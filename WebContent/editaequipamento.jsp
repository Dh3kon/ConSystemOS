<%@page import="com.sistema.dao.EquipamentoDao"%>
<%@page import="com.sistema.model.Equipamento"%>
...
<title>SistemaOS - Editar Equipamento</title>
			...
			<%
			 ...
			 <form action="editaEquip" method="post">
			 	...
			 	<div class="form-group">
					...
					<input type="text" class="form-control" nome="descricao" value="<%=equip.getDescricao() %>">
				</div>
				<div class="form-group">
					<label>Marca</label>
					<input type="text" class="form-control" nome="marca" value="<%=equip.getMarca() %>">
				</div>
				<div class="form-group">
					<label>Fornecedor</label>
					<input type="text" class="form-control" nome="fornecedor" value="<%=equip.getFornecedor() %>">
				</div>
				<div class="form-group">
					<label>Tipo</label>
					<input type="text" class="form-control" nome="tipo" value="<%=equip.getTipo() %>">
				</div>
				<div class="form-group">
					<label>Número de Série</label>
					<input type="text" class="form-control" nome="numSerie" value="<%=equip.getNumSerie() %>">
				</div>
